...
/* SOURCE FILE: pagescripts.js */
 ...
 function generateDropdownMenu(id,index) {
  ...
  if (index==6) {text+='<option value="2008_niagara_video.htm" selected>Niagara Falls videos<br></option>';} 
   else {text+='<option value="2008_niagara_video.htm">Niagara Falls videos<br></option>';}   
  text+='</select></form>';
  document.getElementById(id).innerHTML=text;
 }
